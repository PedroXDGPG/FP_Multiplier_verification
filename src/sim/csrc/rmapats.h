...
void  hs_0_M_0_5__salida_daidir (UB  * pcode, UB  val);
...
void  hs_0_M_1_5__salida_daidir (UB  * pcode, UB  val);
...
void  hs_0_M_8_1__salida_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_8_2__salida_daidir (UB  * pcode);
...
void  hs_0_M_39_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_47_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_48_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_52_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_53_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_54_0__salida_daidir (UB  * pcode, scalar  val);
...
void  hs_0_M_63_9__salida_daidir (UB  * pcode, scalar  val);
...
void  hs_0_M_66_9__salida_daidir (UB  * pcode, scalar  val);
